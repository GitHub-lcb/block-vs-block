# Phase 2 Wave 4 - Implementation Code

This file contains the implementation for Tetris module Wave 4 tasks.

---

## Task 13: TetrisManager.ts

**Target File:** `game/block-vs-block/assets/scripts/tetris/TetrisManager.ts`

```typescript
import { _decorator, Component, director } from 'cc';
import { BlockType, RotationState, Position, InputType, ClearInfo, GameStats } from './TetrisTypes';
...
// 需要导入的类型
import { MoveDirection } from './TetrisTypes';
```

---

## Task 14: index.ts (导出文件)

**Target File:** `game/block-vs-block/assets/scripts/tetris/index.ts`
...
Wave 4 creates 2 files:

1. **TetrisManager.ts** - 主管理器，整合所有子系统，管理游戏循环
2. **index.ts** - 模块导出文件

Total: 14 TypeScript files for complete Tetris module.